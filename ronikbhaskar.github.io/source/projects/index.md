...
<div class="project-card">
  <img src="https://glaze.cs.uchicago.edu/images/glaze-logo-128.png" alt="Glaze Logo">
  <h3>Glaze</h3>
  <p><em>Protecting artists from style mimicry by text-to-image models.</em></p>
  <p>
...
<div class="project-card">
  <h3>LLM Testbed</h3>
  <p><em>Forcing incorrect behavior from LLMs with natural prompts.</em></p>
  <p>
...
<div class="project-card">
  <img src="misc_images/bread.png" alt="optimal bread slicing">
  <h3>Optimal Bread Slicing</h3>
  <p><em>Revisiting a 95-year-old culinary problem.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>A new programming language designed entirely for ordering pizza.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>Using some not-so-sophisticated statistical modeling.</em></p>
  <p>
...
<a href="/anti-eliza">
<div class="project-card">
  <img src="misc_images/anti_eliza.png" alt="anti eliza">
  <h3>Anti-Eliza</h3>
  <p><em>Because anthropomorphizing AI has gotten out of hand.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>LLMs aren't special, everything can generate text.</em></p>
  <p>
...
<div class="project-card">
  <img src="misc_images/chatumm.png" alt="chatumm">
  <h3>ChatUMM</h3>
...
<div class="project-card">
  <img src="misc_images/daylight.jpg" alt="daylight clock">
...
<div class="project-card">
  <img src="misc_images/linear.png" alt="linear transformation on grid of vectors">
  <h3>A Linear Transformation Visualizer</h3>
  <p><em>Helpful for linear algebra students, or anyone visualizing vectors in R^3.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>And no, I don't mean AI. I mean differential equations.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>This definitely doesn't violate Terms of Service</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>"Hacking" Obsidian to do something it should already do.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>Might have been a robot, but he helped me make real friends.</em></p>
  <p>
...
<div class="project-card">
  <img src="misc_images/tomato_timer.png" alt="A Pomodoro Timer."> 
  <h3>A Pomodoro Chrome Extension</h3>
  <p><em>I only built this as an excuse to explore the etymology of pomodoro.</em></p>
  <p>
...
<div class="project-card">
  <img src="misc_images/ultimate_tic_tac_toe_game.png" alt="A game of ultimate tic tac toe."> 
  <h3>A Recreation of Ultimate Tic-Tac-Toe</h3>
  <p><em>Because keeping track of turns manually is too hard.</em></p>
  <p>
...
<div class="project-card">
  <img src="steganography_pngs/image_with_a_secret_message.png" alt="A pretty color gradient."> 
  <h3>Hiding Secret Messages in Images</h3>
  <p><em>Can you find the secret message in that image?</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>Using Math to Beat a Video Game</em></p>
  <p>
...
<div class="project-card">
  <img src="misc_images/forest.png" alt="The game Forest... kinda">
  <h3>Forest</h3>
  <p><em>First I invented a game, then I built a bot to play it perfectly.</em></p>
  <p>
...
<div class="project-card">
  ...
  <p><em>A fever dream of a final project for a class I took in college.</em></p>
  <p>
